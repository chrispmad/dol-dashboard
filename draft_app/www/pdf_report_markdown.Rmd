...
summary_number_one_county_w_text = case_when(
  ...
  var_to_map == 'people_per_provider' ~ paste0(summary_number_one_county,' people per provider for '),
...
summary_number_two_county_w_text = case_when(
  ...
  var_to_map == 'people_per_provider' ~ paste0(summary_number_two_county,' people per provider for '),
...
summary_number_two_county_w_text = paste0("There were ",summary_number_two_county_w_text," Medical/Surgical (Med/Surg) providers in ",ifelse(the_county == 'Contiguous USA', 'the Continental USA', the_county))
```
